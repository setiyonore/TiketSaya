...
public class TicketDetailAct extends AppCompatActivity {
    ...
    LinearLayout btn_back_detail_ticket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spot_ticket = findViewById(R.id.spot_ticket);
        ...
        btn_back_detail_ticket = findViewById(R.id.btn_back_detail_ticket);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            //mengubah data dengan data dari database
                ...
                spot_ticket.setText(dataSnapshot.child("is_photo_spot").getValue().toString());
                wifi_ticket.setText(dataSnapshot.child("is_wifi").getValue().toString());
                festival_ticket.setText(dataSnapshot.child("is_festivals").getValue().toString());
        ...
        btn_back_detail_ticket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
