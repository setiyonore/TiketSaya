...
public class RegisterTwoAct extends AppCompatActivity {
    ...
    ImageView pic_foto_register_user;
    Uri photo_location;
    Integer photo_max = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pic_foto_register_user = findViewById(R.id.pic_foto_register_user);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //getDownloadUrl? User Register II
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == photo_max && resultCode == RESULT_OK && data != null && data.getData() != null){
            ...
            Picasso.with(this).load(photo_location).centerCrop().fit().into(pic_foto_register_user);
        }
    }
